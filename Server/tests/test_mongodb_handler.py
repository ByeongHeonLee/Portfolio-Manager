...
class MongoDBHandlerTestCase(unittest.TestCase):
    def setUp(self):
        ...
        # "stocklab_test" Database의 "corp_info" Collection을 삭제
        self.mongodb._client["stocklab_test"]["corp_info"].drop()

        # Smaple Documents 'docs' 생성
        docs = [
    ...
    def test_insert_item(self):
        """
        mongodb_handler.py의 "MongoDBHandler" Class의 "insert_item()" Method를 테스트한다.
        """
    ...
    def test_insert_items(self):
        """
        mongodb_handler.py의 "MongoDBHandler" Class의 "insert_items()" Method를 테스트한다.
        """
    ...
    def test_find_item(self):
        """
        mongodb_handler.py의 "MongoDBHandler" Class의 "find_item()" Method를 테스트한다.
        """
    ...
    def test_find_items(self):
        """
        mongodb_handler.py의 "MongoDBHandler" Class의 "find_items()" Method를 테스트한다.
        """
    ...
    def test_delete_items(self):
        """
        mongodb_handler.py의 "MongoDBHandler" Class의 "delete_item()" Method를 테스트한다.
        """
    ...
    def test_update_items(self):
        """
        mongodb_handler.py의 "MongoDBHandler" Class의 "update_items()" Method를 테스트한다.
        """
    ...
    def test_aggregate(self):
        """
        mongodb_handler.py의 "MongoDBHandler" Class의 "aggregate()" Method를 테스트한다.
        """
